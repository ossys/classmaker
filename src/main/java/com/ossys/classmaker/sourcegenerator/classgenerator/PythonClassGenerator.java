 ...
 *
 */
public class PythonClassGenerator extends ClassGenerator {

	private List<JavascriptMethodGenerator> methods = new ArrayList<JavascriptMethodGenerator>();
	
	public PythonClassGenerator(String name) {
		super(name);
	}
	
	public PythonClassGenerator(String name, String path) {
		super(name,path + System.getProperty("file.separator") + ClassGenerator.getClassName(name) + ".js");
	}
	
	public PythonClassGenerator(String name, String path, NamingSyntaxType type) {
