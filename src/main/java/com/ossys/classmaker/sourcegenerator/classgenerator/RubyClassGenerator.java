 ...
 *
 */
public class RubyClassGenerator extends ClassGenerator {

	private List<JavascriptMethodGenerator> methods = new ArrayList<JavascriptMethodGenerator>();
	
	public RubyClassGenerator(String name) {
		super(name);
	}
	
	public RubyClassGenerator(String name, String path) {
		super(name,path + System.getProperty("file.separator") + ClassGenerator.getClassName(name) + ".js");
	}
	
	public RubyClassGenerator(String name, String path, NamingSyntaxType type) {
